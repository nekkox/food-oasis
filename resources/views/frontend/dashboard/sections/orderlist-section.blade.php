    ...
    <div class="fp_dashboard_body">
        ...
        @foreach($orders as $order)
            <div class="fp__invoice invoice_details_{{ $order->id }}">
                <a class="go_back" onclick="hideInvoice('{{$order->id}}')"><i class="fas fa-long-arrow-alt-left"></i> go
                    back</a>
                <div class="fp__track_order">
                    ...
                    ">order declined
                        ...
                        @else
                            ...
                            <li class="
                    {{ in_array($order->order_status, ['pending', 'in_process', 'delivered']) ? 'active' : '' }}
                    ">order pending
                            </li>
                            <li class="
                    {{ in_array($order->order_status, ['in_process', 'delivered']) ? 'active' : '' }}
                    ">order in process
                            </li>
                            <li class="
                            ...
                            @foreach($order->order_items as $item)
                                ...
                                <tr>
                                    ...
                                    <td class="package">
                                        ...
                                        <span
                                            class="size">{{ @$size->name }} - {{ @$size->price ? currencyPosition(@$size->price) : ''}}</span>
