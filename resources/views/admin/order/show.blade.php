                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <address>
                                        ...
                                        <br>
                                        <strong>Last Name:</strong> {!! @$order->userAddress->last_name !!}
                                        <br>
                                        <strong>Phone:</strong> {!! @$order->userAddress->phone !!}
                                        <br>
                                        <strong>Address:</strong> {!! @$order->userAddress->address !!}
                                        <br>
                                        <strong>Address:</strong> {!! @$order->userAddress->deliveryArea->area_name !!}
                                    </address>
                                </div>
                            ...
                            <div class="row mt-4">
                                        ...
                                        <form action="{{ route('admin.orders.status-update', $order->id) }}"
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select class="form-control" name="payment_status" id="">
                                                    <option
                                                        @selected($order->payment_status === 'pending') value="pending">
                                                        Pending
                                                    </option>
                                                    <option
                                                        @selected($order->payment_status === 'completed') value="completed">
                                                        Completed
                                                    </option>
                                                </select>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select class="form-control" name="order_status" id="">
                                                    <option
                                                        @selected($order->order_status === 'pending') value="pending">
                                                        Pending
                                                    </option>
                                                    <option
                                                        @selected($order->order_status === 'in_process') value="in_process">
                                                        In Process
                                                    </option>
                                                    <option
                                                        @selected($order->order_status === 'delivered') value="delivered">
                                                        Delivered
                                                    </option>
                                                    <option
                                                        @selected($order->order_status === 'declined') value="declined">
                                                        Declined
                                                    </option>
                                ...
                                <div class="col-lg-4 text-right">
                                    ...
                                    <div class="invoice-detail-item">
                                        ...
                                        <div
                                            class="invoice-detail-value">{{ currencyPosition($order->delivery_charge) }}</div>
                                    </div>
                                    <hr class="mt-2 mb-2">
                                    <div class="invoice-detail-item">
                                        ...
                                        <div class="invoice-detail-item">
                                            ...
                                            <div
                                                class="invoice-detail-value invoice-detail-value-lg">{{ currencyPosition($order->grand_total) }}</div>
                                        </div>
                                    </div>
                                </div>
                            </div>
