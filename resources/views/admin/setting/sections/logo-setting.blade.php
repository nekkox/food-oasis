...
<div class="tab-pane fade show" id="logo-setting" role="tabpanel" aria-labelledby="logo-tab4">
    <div class="card">
        <div class="card-body border">
            <form action="{{ route('admin.logo-setting.update') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="row">
                    <div class="col-md-3">
                        <div class="form-group row custom-mr" >
                            <label class="text-center " style="width:100%">Logo</label>
                            <div id="image-preview" class="image-preview logo" style="width:100%">
                    ...
                    <div class="col-md-3">
                        <div class="form-group row custom-mr" >
                            <label class="text-center" style="width:100%">Footer Logo</label>
                            <div id="image-preview-2" class="image-preview footer_logo" style="width:100%">
                    ...
                    <div class="col-md-3">
                        <div class="form-group row custom-mr" >
                            <label class="text-center" style="width:100%">Favicon</label>
                            <div id="image-preview-3" class="image-preview favicon" style="width:100%">
                    ...
                    <div class="col-md-3">
                        <div class="form-group row" >
                            <label class="text-center" style="width:100%">Breadcrumb</label>
                            <div id="image-preview-4" class="image-preview breadcrumb" style="width:100%">
